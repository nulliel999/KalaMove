...
set "EXTERNAL_TARGET=..\Elypso-engine\_external_shared"
set "DEBUG_TARGET=..\Elypso-engine\_external_shared\KalaWindow\debug"
set "RELEASE_TARGET=..\Elypso-engine\_external_shared\KalaWindow\release"
...
set "CLEAN_IMGUI=..\Elypso-engine\_external_shared\delete_imgui_vulkan_files.bat"
